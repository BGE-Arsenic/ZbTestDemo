package com.example.apple.zbtestdemo.storeage;

import android.content.Context;
import android.content.SharedPreferences;

import com.example.apple.zbtestdemo.BaseApplication;

/**
 * Created by apple on 2017/6/20.
 */

public enum StoreageManager {
    INSTANCE;
    ...
    public void setListShowImg(boolean listShowImg) {
        SharedPreferences sharedPreferences = BaseApplication.getBaseApplication().getSharedPreferences(spName, Context.MODE_PRIVATE);
